...
function getHomeData() {
    return async(dispach) => {
        ...
        const festivalBannerListApi = axios.get(`https://apis.data.go.kr/6260000/FestivalService/getFestivalKr?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&resultType=json`)
